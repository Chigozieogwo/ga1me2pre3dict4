...
import { listUsersAdmin, deleteUser } from '../actions/userActions.js'
import Countdown, { zeroPad } from 'react-countdown'
import moment from 'moment'

const UserListAdminScreen = ({ history, match }) => {
  ...
  const { loading, error, users, page, pages } = userListAdmin
  ...
  useEffect(() => {
    dispatch(listUsersAdmin(pageNumber))
  }, [dispatch, pageNumber])
